...
public interface ClientesServices extends Clientes {
    ...
    @Modifying
    @Transactional
    @Query(value = "DELETE FROM clientes WHERE nombrecliente like :nombrecliente", nativeQuery = true)
    void borrarcliente(@Param("nombrecliente") String nombrecliente);
    ...
    void modificarcliente(@Param("nombrecliente") String nombrecliente, @Param("nombreusuario") String nombreusuario,
